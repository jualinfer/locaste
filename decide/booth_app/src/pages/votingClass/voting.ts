...
export class VotingPage {
  ...
  constructor(
    ...
    let startString: string = String(this.voting.start_date).substring(0, 10) + " " + String(this.voting.start_date).substring(11, 16);
    ...
    let endString: string = String(this.voting.end_date).substring(0, 10) + " " + String(this.voting.end_date).substring(11, 16);
    ...
    this.options = this.voting.question.options;
  ...
  public vote(voting: Voting, option: Option) {
    console.log(voting);
    console.log(option);
    this.dm.vote(voting, option).then((data) => {
